...
(function ($) {
    ...
    $.fn.lightGallery = function (options) {
        ...
        var setUp = {
                        ...
                        for (i = 0; i <= index - 1; i++) {
                            ...
                            if (settings.mobileSrc === true && windowWidth <= settings.mobileSrcMaxWidth) {
                                ...
                                if (settings.dynamic == true) {
                                    ...
                                    id = $children.eq(index - i - 1).attr('data-id');
                                    desc = $children.eq(index - i - 1).attr('data-desc');
                                }
                            }
                            if (!$this.isVideo(src)) {
                           ...
                           $this.buildThumbnail(id,desc,$slide.eq(index - i - 1));
                        }
                        for (j = 1; j < l; j++) {
                            var src,desc,id;
                            if (settings.mobileSrc === true && windowWidth <= settings.mobileSrcMaxWidth) {
                                ...
                                if (settings.dynamic == true) {
                                    ...
                                    id=   $children.eq(index + j).attr('data-id');
                                    desc= $children.eq(index + j).attr('data-desc');
                                }
                            }
                            if (!$this.isVideo(src)) {
                            ...
                            $this.buildThumbnail(id,desc,$children.eq(index + j));
                        }
                    });
                }
            },
            ...
            buildThumbnail: function (id,summary,$that) {
                if (settings.thumbnail === true && $children.length > 1) {
                    var $this = this;
                    $that.append('<div class="thumb_cont">' +
                                        '<div class="thumb_info">' +
                                         '<p>'+summary+'</p>'+
                                        '</div>' +
                                        '<div class="thumb_inner"  style="display: none">' +
                                        '</div>' +
                                        '<div class="picDz">' +
                                               '<a href="javascript:;" data-id="'+id+'">' +
                                                   '<img src="/Public/Mobile/images/photoDz.png"/>'+
                                                   '<em>1910人点赞</em>'+
                                               '</a> '+
                                        '</div>' +
                                        '<div class="inputtcCont">'+
                                          '<div class="inputtc">'+
                                                ' <div>'+
                                                ' <textarea contenteditable="true" style="overflow-x:auto"></textarea>'+
                                                ' </div>'+
                    ...
                    $gallery.find(".thumb_info>p").bind('click',function () {
                        $(".inputtcCont").show();
                        $gallery.find(".inputtcCont textarea").text($(this).text());
                        $gallery.find(".inputtcCont textarea").focus();
                    })

                    //输入确定
                    $gallery.find(".inputtc>a").bind('click',function () {
                        $(".inputtcCont").hide();
                        $gallery.find(".inputtcCont textarea").blur();
                    })

                    //点赞
                    $gallery.find(".picDz>a").bind('click',function () {
                          var $a=$(this);
                           if(!$a.hasClass("active")){
                               $a.addClass("active");
                               $(this).children("img").attr("src","/Public/Mobile/images/proDz1.png")
                           }
                           else{
                               $a.removeClass("active");
                               $(this).children("img").attr("src","/Public/Mobile/images/photoDz.png")
                           }
                    })
            ...
            slideTo: function () {
                ...
                if (settings.controls === true && $children.length > 1) {
                    $gallery.append('<div id="lightGallery-action" style="display: none"><a id="lightGallery-prev"></a><a id="lightGallery-next"></a></div>');
